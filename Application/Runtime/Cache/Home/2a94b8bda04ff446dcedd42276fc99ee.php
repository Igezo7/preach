...
<body>
    <div class="container">
        <div class="cover alert" style="display: none;">
            <div class="alert-box">
                <div class="alert-icon">
                    <img src="./Public/img/aIcon.png" alt="">
                </div>
        ...
        <div class="content">
            <div class="paper">
                <img src="./Public/img/paper.png" alt="">
            </div>
            <div class="left-hand-1">
                <img src="./Public/img/lefth1.png" alt="">
            </div>
            <div class="left-hand-2">
                <img src="./Public/img/lefth2.png" alt="">
            </div>
            <div class="right-hand">
                <img src="./Public/img/righth.png" alt="">
            </div>
        </div>
